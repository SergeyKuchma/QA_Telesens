...
public class SubscriberHomeTask_v3 {
...
//*******************************************************************************************************
        //отсортировать сразу по 4 полям:
                //- оператору
                //- по возрасту
                //- по фамилии
                //- по имени
//*******************************************************************************************************
        subscriberList.sort((o1, o2)-> {
            if (o1.getOperator().getName().equals(o2.getOperator().getName()))
                    //когда по оператору они равны, то смотрим на Age
                    if (o1.getAge()==(o2.getAge()))
                        //это если Ages равны
                        if (o1.getLastName().equals(o2.getLastName()))// если по Фамилии они равны
                            return o1.getFirstName().compareTo(o2.getFirstName());  // сортировка по Имени
                        else return o1.getLastName().compareTo(o2.getLastName());// если по Фамилии они не равны
                    //это если по возрасту они не равны
                    else return Integer.compare(o1.getAge(), o2.getAge());
            else //это если Оператор не одинаковый, то сортируем по нему:
